...
def create_parser():
    ...
    parser.add_argument('-flip', default=False, help='Should we use flip as an augmentation technique', type=bool,
                        required=False)
...
if __name__ == '__main__':
    ...
    preprocess_data(args.dir, args.ts, args.vs, args.flip, args.save_dir, args.seed)
